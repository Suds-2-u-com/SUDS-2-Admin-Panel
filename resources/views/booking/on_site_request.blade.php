...
<!-- row -->
						...
						<div class="card mg-b-20">
							<div class="card-header pb-0 pd-t-25">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">On Site Requests</h4>
								</div>
									...
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-15p border-bottom-0">Type oF Wash</th>
										...
										<tbody>
											@if(!empty($onsiterequest))
											@php $i=0; @endphp
											@foreach($onsiterequest as $rows)
											@php $i++ @endphp
											<tr>
												<td>{{$i}}</td>
												...
												<td>{{$rows['zip_code']}}</td>
												<td>{{$rows['address']}}</td>
												<td>{{categoryname($rows['type_of_wash'])}}</td>
												<td>{{$rows['how_many']}}</td>
												...
												<td>
												  <div class="dropdown btn-group mt-2 mb-2">
													...
													<div  class="dropdown-menu shadow tx-13">
													    <a class="dropdown-item viewDetailsonsite" href="javascript:void(0);" data-id="{{$rows['id']}}">View Details</a>
													    <a class="dropdown-item editOnSiteRequest" data-id="{{$rows['id']}}" >Edit</a>
														<?php if($rows['status']==0){?>
														<a class="dropdown-item" href="javascript:void(0);" onclick="return confirmDeleteEntry('<?php echo encryption($rows['id']); ?>','on_site_request','id');">Delete</a>
													
														<a class="dropdown-item" href="javascript:void(0);" onclick="return confirmAcceptEntry('<?php echo encryption($rows['id']); ?>','on_site_request','id');">Accept</a>
														<a class="dropdown-item" href="javascript:void(0);" onclick="return confirmRejectEntry('<?php echo encryption($rows['id']); ?>','on_site_request','id');">Reject</a>
					...
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content modal-content-demo">
							<div class="modal-header">
								<h6 class="modal-title" id="changeContent">ON SITE REQUESTS DETAILS</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
							</div>
				...
				<div class="modal" id="onsiterequestedit">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content modal-content-demo">
							<div class="modal-header">
							...
							<div class="modal-body" id="onsiterequestmodal">
