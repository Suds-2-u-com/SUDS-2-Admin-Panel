                            ...
                            <table width="600" border="0" cellpadding="0" cellspacing="0" class="force-row"
                                ...
                                <tr style="background-color: black;">
                                    <td style="text-align: center;">
                                        <a href="http://coloredge.com" title="Coloredge">
                                            <img src="https://suds-2-u.com/public/logo-2.svg"
                                ...
                                <tr>
                                    <td class="content-wrapper"
                                        ...
                                        <p
                                            style="font-family:sans-serif;font-size: 14px !important;margin-top: 15px; margin-bottom: 15px;line-height: 1.4 !important;">
                                            <?php echo $messages;?></p>
                                    </td>
                                </tr>
                                <table width="600" border="2" cellpadding="0" cellspacing="0" class="force-row"
                                style="width: 600px;">
                                    <tr>
                                        <th>Coupon Code</th>
