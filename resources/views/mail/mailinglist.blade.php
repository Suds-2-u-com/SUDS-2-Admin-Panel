						...
						<div class="card mg-b-20">
							<div class="card-header pb-0 pd-t-25">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">Mailing List </h4>
												...
												<td>
												  <div class="dropdown btn-group mt-2 mb-2">
													...
													<div  class="dropdown-menu shadow tx-13">
														...
														<a class="dropdown-item" href="javascript:void(0);" onclick="return confirmDeleteEntry('<?php echo encryption($rows->id); ?>','mailing','id');">Delete</a>
