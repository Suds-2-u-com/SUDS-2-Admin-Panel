...
<table width="600" border="0" cellpadding="0" cellspacing="0" class="force-row" style="width: 600px;">
  ...
  <tr>
    <td class="content-wrapper" style="padding-left:24px;padding-right:24px;text-align: center;">
      <p style="text-transform:uppercase;font-family:sans-serif;font-size: 24px !important;margin-top: 15px; margin-bottom: 15px;">Hi, {{ $name }}</p> 
      <p style="font-family:sans-serif;font-size: 14px !important;margin-top: 15px; margin-bottom: 15px;line-height: 1.4 !important;">Forget Password Link.</p> 
    ...
    <td class="content-wrapper" style="padding-left:24px;padding-right:24px;text-align: center;" align="center">
      ...
      <div>
              ...
              <a href="<?php echo isset($link) ? $link : ''; ?>"
                style="background-color:#f4791f;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:47px;text-align:center;text-decoration:none;width:124px;-webkit-text-size-adjust:none;">Click here</a>
