...
<head>
  ...
  <title>Announcing New Website, New Brand</title>
...
<table width="600" border="0" cellpadding="0" cellspacing="0" class="force-row" style="width: 600px;">
  <tr style="background-color: black;">
    <td style="text-align: center;">
      <a href="http://coloredge.com" title="Coloredge">
        <img  src="https://suds-2-u.com/public/logo-2.svg" style="width: 50%;height: 50%;">
      </a>
    </td>
  </tr>
  <tr>
    <td class="content-wrapper" style="padding-left:24px;padding-right:24px;text-align: center;">
      <p style="text-transform:uppercase;font-family:sans-serif;font-size: 24px !important;margin-top: 15px; margin-bottom: 15px;">Coloredge Unveils<br> New Website, New Brand</p> 
  ...
  <tr>
    <td class="content-wrapper" style="padding-left:24px;padding-right:24px;text-align: center;" align="center">
      ...
      <br>
      <p style="text-transform:uppercase;font-family:sans-serif;font-size: 14px !important;margin-top:0; margin-bottom: 15px;text-align: center;">Learn more about our visual marketing solutions.</p>
      <div>
       
              <a href="mailto:nae@coloredge.com"
        style="background-color:#f4791f;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:47px;text-align:center;text-decoration:none;width:124px;-webkit-text-size-adjust:none;">EMAIL US</a>
